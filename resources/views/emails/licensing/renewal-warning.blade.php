...
<head>
    ...
    <title>Renew your licence</title>
</head>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#ffffff;border-radius:12px;overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:32px;">
                            <h1 style="margin:0 0 12px;font-size:22px;">Renew to keep your premium features</h1>
                            <p style="margin:0 0 16px;line-height:1.6;color:#444;">
                                We couldn't renew your KURSA licence, so your academy is now in a grace period.
                                @if ($graceEndsAt)
                                    Please update your payment before
                                    <strong>{{ $graceEndsAt->format('F j, Y') }}</strong>
                                    to avoid losing premium capabilities.
                                @endif
                                Your courses, learners and certificates are safe either way — if the grace period ends,
                                your academy simply returns to Free Forever.
                            </p>
