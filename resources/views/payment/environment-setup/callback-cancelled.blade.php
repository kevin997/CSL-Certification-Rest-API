...
<head>
    ...
    <title>Payment Cancelled - {{ $companyName }}</title>
...
<body class="antialiased bg-gray-50"
    ...
    <div class="min-h-screen flex flex-col items-center justify-center p-4">
        <div class="w-full max-w-md bg-white rounded-lg shadow-lg overflow-hidden card">
            ...
            <div class="p-8 text-center">
                ...
                <p class="text-gray-600 mb-6">Your supported plan setup payment was cancelled. Don't worry, you can try again anytime.</p>
                ...
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-gray-500 mt-4">Redirecting you to continue setup...</p>
                </div>
        ...
        <div class="mt-8 text-center text-sm text-gray-500">
            ...
            <p class="mt-2">Need help? <a href="https://sales.csl-brands.com/contact" class="text-primary hover:underline">Contact our support team</a>.</p>
        </div>
    </div>
    ...
    <script>
        ...
        setTimeout(function() {
            ...
            var redirectUrl = 'https://sales.csl-brands.com/onboarding/supported-plan/payment-cancelled';
