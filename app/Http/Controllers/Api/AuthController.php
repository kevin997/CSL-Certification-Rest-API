...
class AuthController extends Controller
{
     ...
     *             @OA\Property(property="environment_id", type="integer", example=1, description="Optional environment ID for environment-specific authentication")
     *         )
     *     ),
     *     @OA\Response(
     *         response=200,
     ...
     *         @OA\JsonContent(
     *             @OA\Property(property="token", type="string", example="1|laravel_sanctum_NvGqIuUGK6Vj5AEDlxSNRgVuIJxBMpLK4ryhfnLq"),
     ...
     *             ),
     *             @OA\Property(property="environment_id", type="integer", example=1, description="The environment ID used for authentication, if applicable")
     *         )
     *     ),
     *     @OA\Response(
     *         response=401,
    ...
    public function login(Request $request)
    {
        ...
        // The actual implementation is handled by Laravel Sanctum
    }
     ...
     *             @OA\Property(property="role", type="string", enum={"learner", "individual_teacher", "company_teacher"}, example="learner"),
     ...
     *             @OA\Property(property="email", type="string", format="email", example="user@example.com"),
     *             @OA\Property(property="role", type="string", example="learner"),
     *             @OA\Property(property="company_name", type="string", example="Acme Corp", nullable=true),
     *             @OA\Property(property="created_at", type="string", format="date-time"),
     *             @OA\Property(property="updated_at", type="string", format="date-time")
     *         )
     *     ),
