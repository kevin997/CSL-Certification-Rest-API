...
class QuizContentController extends Controller
{
    ...
    public function store(Request $request, $activityId)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'questions.*.question_type' => 'required|string|in:multiple_choice,true_false,short_answer,matching,fill_blank',
            'questions.*.options' => 'required_if:questions.*.question_type,multiple_choice,matching|array',
            'questions.*.options.*.text' => 'required_if:questions.*.question_type,multiple_choice,matching|string',
            'questions.*.options.*.is_correct' => 'required_if:questions.*.question_type,multiple_choice|boolean',
            'questions.*.correct_answer' => 'required_if:questions.*.question_type,true_false,short_answer,fill_blank',
    ...
    public function update(Request $request, $activityId)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'questions.*.question_type' => 'required_with:questions|string|in:multiple_choice,true_false,short_answer,matching,fill_blank',
            'questions.*.options' => 'required_if:questions.*.question_type,multiple_choice,matching|array',
            'questions.*.options.*.text' => 'required_if:questions.*.question_type,multiple_choice,matching|string',
            'questions.*.options.*.is_correct' => 'required_if:questions.*.question_type,multiple_choice|boolean',
            'questions.*.correct_answer' => 'required_if:questions.*.question_type,true_false,short_answer,fill_blank',
