...
use Database\Seeders\AfricanTaxZoneSeeder;
use Database\Seeders\TaxZoneSeeder;
use Database\Seeders\EnvironmentPaymentConfigSeeder;
use Database\Seeders\TaraMoneyGatewaySeeder;
